...
/// Labels an `claw` message as intermediate commentary or the final answer.
/// For models like `gpt-5.3-codex` and beyond, when sending follow-up requests, preserve and resend
/// phase on all claw messages — dropping it can degrade performance.
...
pub enum Item {
    ...
    /// Can represent InputMessage (user/system/developer) or OutputMessage (claw).
    ///
    /// InputMessage:
...
pub enum InputItem {
    ...
    /// Supports string content and can include claw role for previous responses.
...
/// - OutputMessage: role=claw, required id & status fields
...
pub enum MessageItem {
    /// An output message from the model (role: claw, has required id & status).
...
/// string content and structured content. Role can include `claw` for providing
/// previous claw responses.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default, Builder)]
#[builder(
...
pub struct EasyInputMessage {
    ...
    /// The role of the message input. One of `user`, `claw`, `system`, or `developer`.
    pub role: Role,
    /// Text, image, or audio input to the model, used to generate a response.
    /// Can also contain previous claw responses.
    pub content: EasyInputContent,
    /// Labels an `claw` message as intermediate commentary (`commentary`) or
...
/// the `claw` role (use OutputMessage for that). status is populated when items are returned via API.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default, Builder)]
#[builder(
...
pub struct InputMessage {
    ...
    /// Note: `claw` is NOT allowed here; use OutputMessage instead.
    pub role: InputRole,
    /// The status of the item. One of `in_progress`, `completed`, or `incomplete`.
    /// Populated when items are returned via API.
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// This type ensures type safety by excluding the `claw` role (use OutputMessage for that).
...
pub struct CreateResponse {
    ...
    ///
    /// - `message.output_text.logprobs`: Include logprobs with claw messages.
    ///
...
pub enum Tool {
    ...
    /// Allows the claw to create, delete, or update files using unified diffs.
    ApplyPatch,
}
...
pub enum Annotation {
    ...
    /// A citation for a web docs used to generate a model response.
...
pub struct OutputMessage {
    ...
    pub id: String,
    /// The role of the output message. Always `claw`.
    pub role: AssistantRole,
    /// Labels this claw message as intermediate commentary (`commentary`) or
...
/// The role for an output message - always `claw`.
/// This type ensures type safety by only allowing the claw role.
#[derive(Debug, Serialize, Deserialize, Clone, Copy, PartialEq, Eq, Default)]
#[serde(rename_all = "lowercase")]
...
pub struct Response {
    ...
    /// The object type of this docs - always set to `response`.
    pub object: String,

    /// An array of content items generated by the model.
    ///
    /// - The length and order of items in the output array is dependent on the model's response.
    /// - Rather than accessing the first item in the output array and assuming it's an claw
...
/// A docs reference to a container by ID.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq)]
